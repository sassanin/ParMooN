...
void ExampleFile()
{
  OutPut("Example: Benchmark_FlowPastCylinder" << endl) ;
}
               ...
               double **parameters, double **coeffs)
{
  ...
  int i;
  double *coeff, *param, tau1x, tau1y, tau2x, tau2y, tau3x, tau3y, nondim;
  nondim = (beta-1.0)*eps*nu;
  
  eps = eps*beta;    // beta/Re due to only solvent contribution
