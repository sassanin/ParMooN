...
// ----------- Description  ----------------------//
// In a square Domain, apply dirichlet boundary on all edges with value of 1 on one side of the domain
// and zero on other side //

void ExampleFile()
{
  OutPut("Example: TempDistribution.h" << endl) ;
}
